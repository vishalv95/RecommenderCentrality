...
centrality_types = pd.read_csv("centrality_data/user_centrality.csv").columns
...
for method in ["user_centrality", "movie_centrality"]:
    for centrality_measure in centrality_types:
        for alpha in np.arange(0, 1.1, 0.1):
            ...
            df = pd.DataFrame(result_rows, columns=["method", "centrality_measure", "alpha", "precision_at_N", "recall_at_N", "precision_threshold", "recall_threshold", "ndcg", "rmse"]
